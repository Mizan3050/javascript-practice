...
newMap.set({ a: 1, b: 2 }, { name: "Arshad", age: 31 });
newMap.set({ a: 1, b: 2 }, { name: "Arshad", age: 31 });
...
// Map is a data structure that guarantees the order of the keys, it holds key value pairs where both keys and values can have any data type
